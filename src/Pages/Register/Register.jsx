      ...
      .then((res) => {
        ...
        updateProfile(auth.currentUser, {
          ...
          .then((res) => {
            ...
            const photoUrl = data.phUrl;
            const dataOfUsers = { name, email, photoUrl };

            axiosPublic.post("/usersData", dataOfUsers).then((res) => {
              if (res.data) {
                Swal.fire({
                  position: "top-end",
                  icon: "success",
  ...
  return (
    <div className="flex flex-col justify-center my-16 items-center">
      <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
        <div className="relative grid mx-4 mb-4 -mt-6 overflow-hidden text-white shadow-lg h-28 place-items-center rounded-xl bg-primaryColor bg-clip-border shadow-gray-900/20">
